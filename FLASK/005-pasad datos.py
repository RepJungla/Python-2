...
datos = {'nombre':'Héctor Quirós Pérez'}                #Creamos la variable datos con todo el diccionario

@app.get("/")                                           #Escuchamos en la raiz de la web
def inicio():                                            #Creamos una función
    return render_template("datos.html", misdatos=datos)               #Buscará en la carpeta "templates" el html
